...
namespace PMS.Migrations
{
    ...
    [Migration("20220925173330_Fourth Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Models.Products.ProductAttributesModel", b =>
                {
                    b.HasOne("Model.Models.Attributes.AttributesModel", "Attributes")
                        .WithMany()
                        .HasForeignKey("Attribute_Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Model.Models.Products.ProductsModel", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Models.Products.ProductDetailsModel", b =>
                {
                    b.HasOne("Model.Models.Products.ProductsModel", "Product")
                        ...
                        .HasForeignKey("Model.Models.Products.ProductDetailsModel", "Product_Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Model.Models.Products.ProductsModel", b =>
                {
                    b.HasOne("Model.Models.Category.CategoryModel", "Category")
                        .WithMany()
